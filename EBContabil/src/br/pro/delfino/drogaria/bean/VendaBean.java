...
public class VendaBean implements Serializable {
	...
	public void adicionar(ActionEvent evento) {
		...
		int achou = -1; // essa variavel significa que nao achou. Positivo significa que achou.
	...
	public void finalizar() {
		try {
			...
			venda.setCliente(null); //limpa o combo
			venda.setFuncionario(null); // limpa o combo
